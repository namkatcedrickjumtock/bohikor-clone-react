...
const Terms = () => {
  return (
    <div className="container py-5 my-5 mt-5" id="terms">
      <p className="my-5">
        Bohikor Privacy Policy <br className="my-5" />
        Last updated May 2022
      </p>

      <p>
        Bohikor SAS respects the privacy of our users (“user” or “you”) and this
        Privacy Policy explains how we collect, use, disclose, and safeguard
        your information when you visit our mobile application (Bohikor) or make
        use of any of our services. Please read this Privacy Policy carefully.
      ...
      <p>
        ...
        and materials you use and includes: Personal Data
      </p>
      ...
      <p>
        ...
        posting messages in comment sections or in our forums, liking posts,
        sending feedback, and responding to surveys. If you choose to share data
        about yourself via your profile, online chat, or other interactive areas
        of the Application, please be advised that all data you disclose in
      ...
      <p>
        ...
        device. If you wish to change our access or permissions, you may do so
      ...
      <p>
        ...
        <br className="my-2" />
        Third-Party Data Information from third parties, such as personal
        ...
        Data From Challenges, Giveaways, and Surveys Personal and other
        information you may provide when entering challenges or giveaways and/or
      ...
      <p>
        ...
        situations. Your information <br className="my-2" />
        ...
        reduction. <br className="my-2" />
        Third-Party Service Providers We may share your information with third
        ...
        service, and marketing assistance. <br className="my-2" />
        ...
        Other Users <br className="my-2" />
        If you interact with other users of the Application, those users may see
        your name, profile photo, and descriptions of your activity, including
        sending invitations to other users, chatting with other users, liking
        posts, and following blogs. Third-Party Advertisers{" "}
        <br className="my-2" />
        ...
        common control with us. Business Partners <br className="my-2" />
        We may share your information with our business partners to offer you
        certain products, services, or promotions. <br className="my-2" />
        Offer Wall The Application may display a third-party-hosted “offer
        ...
        may appear in the Application and be displayed to you based on certain
        ...
        <br className="my-2" />
        Other Third Parties We may share your information with advertisers and
        investors for the purpose of conducting general business analysis. We
        may also share your information with such third parties for marketing
        purposes, as permitted by law. <br className="my-2" />
        Sale or Bankruptcy If we reorganize or sell all or a portion of our
        ...
        commitments we made in this Privacy Policy. <br className="my-2" />
      ...
      <p>
        ...
        on an individual basis Internet-Based Advertising{" "}
        <br className="my-2" />
        ...
        interest-based ads, visit the Network Advertising Initiative Opt-Out
        Tool or Digital Advertising Alliance Opt-Out Tool. Website Analytics{" "}
        <br className="my-2" />
        We may also partner with selected third-party vendors, such as Google
        Analytics to allow tracking technologies and remarketing services on the
        ...
        understand online activity. By accessing the Application, you consent to
        ...
        information to these third-party vendors. <br className="my-2" />
      ...
      <p>
        THIRD-PARTY WEBSITES <br className="my-2" />
      ...
      <p>
        SECURITY OF YOUR INFORMATION <br className="my-2" />
      ...
      <p>
        POLICY FOR CHILDREN <br className="my-2" />
      ...
      <p>
        OPTIONS REGARDING YOUR INFORMATION <br className="my-2" />
        ...
        <ul>
          ...
          <li>
            {" "}
            Contacting us using the contact information provided below Upon your
            ...
            correspondence, emails, or other communications from us, you may opt
            out by
          </li>
          <li>
            {" "}
          ...
          <li>
            {" "}
            Login into your account settings and update your preferences.
          </li>
          <li>
          ...
          <p>
            CAMEROON PRIVACY RIGHTS In the preamble to the Constitution of the
            Republic of Cameroon, Law No. 96/6 of 18 January 1996 revising the
            Constitution of 02 June 1972, as amended and supplemented by Law No.
            2008/001 of 14 April 2008 (‘the Constitution’), it is stated that:
          </p>
          <li>
            {" "}
            the people of Cameroon affirm their attachment to the fundamental
            freedoms enshrined in the Universal Declaration of Human Rights
            1945, the Charter of the United Nations 1945, the African Charter on
            Human and Peoples’ Rights 1981, which are all duly ratified;
          </li>
          <li> international conventions relating thereto;</li>
          <li>
            {" "}
            freedom and security are guaranteed to every individual with due
            respect for the rights of others and the best interests of the
            State;
          </li>
          <li>
            {" "}
            privacy of all correspondence is inviolable – no interference may be
            allowed except as provided in a judicial decision.
          </li>
          <p>
            Data protection is, therefore, a right enshrined in the
            Constitution. <br className="my-2" />
            If you are under 18 years of age, reside in Cameroon, and have a
            registered account with Bohikor SAS, you have the right to request
            the removal of unwanted data that you publicly post on the
            Application. To request the removal of such data, please contact us
            ...
            in Cameroon. We will make sure the data is not publicly displayed on
