    ...
    return (
        <div className='container bg-light w-50 py-5 my-5 mt-5'>
            ...
            <p>Bohikor SAS respects the privacy of our users (“user” or “you”) and this Privacy Policy explains
                how we collect, use, disclose, and safeguard your information when you visit our mobile
                application (Bohikor) or make use of any of our services. Please read this Privacy Policy
                carefully. IF YOU DO NOT AGREE WITH THE TERMS OF THIS PRIVACY POLICY, PLEASE DO NOT
                ACCESS ANY OF OUR PRODUCTS OR SERVICES.</p>
            ...
            <p>This Privacy Policy does not apply to the third-party online/mobile store from which you install
            ...
            <p>We may collect information about you in a variety of ways. The information we may collect via
            ...
            <p>Demographic and other personally identifiable information (such as your name and email
                ...
                to the Application, such as posting messages in comment sections or in our forums, liking
                ...
                accesses the Application.</p>

            <p>Mobile Device Access</p>
            <p>We may request access or permission to certain features from your mobile device. If you wish
                to change our access or permissions, you may do so in your device’s settings
                <br className='my-2' />
                Mobile Device Data</p>

            <p>Device information such as your mobile device ID number, model, and manufacturer, version of
                ...
                Data From Challenges, Giveaways, and Surveys
                Personal and other information you may provide when entering challenges or giveaways and/or
                responding to surveys.
            </p>

            <p>
                USE OF YOUR INFORMATION <br className='my-2' />
                ...
                <ol>
                    ...
                    <li>Deliver targeted advertising, coupons, newsletters, and other information regarding
                        promotions and the Application to you.</li>
                    <li> Email me regarding your account or order.</li>
                    <li>Enable user-to-user communications.</li>
                    <li> Generate a personal profile about you to make future visits to the Application more
                        personalized.</li>
            ...
            <p>DISCLOSURE OF YOUR INFORMATION
                <br className='my-2' />
                We may share information we have collected about you in certain situations. Your information <br className='my-2' />
                may be disclosed as follows: <br className='my-2' />
                By Law or to Protect Rights <br className='my-2' />
                ...
                Interactions with Other Users <br className='my-2' />
                ...
                Third-Party Advertisers <br className='my-2' />
                ...
                of interest to you. <br className='my-2' />
                Affiliates
                ...
                Business Partners <br className='my-2' />
                We may share your information with our business partners to offer you certain products,
                services, or promotions. <br className='my-2' />
                Offer Wall
                The Application may display a third-party-hosted “offer wall.” Such an offer wall allows
                third-party advertisers to offer virtual currency, gifts, or other items to users in return for
                acceptance and completion of an advertisement offer. Such an offer wall may appear in the
                Application and be displayed to you based on certain data, such as your geographic area or
                demographic information. When you click on an offer wall, you will leave the Application. A
                unique identifier, such as your user ID, will be shared with the offer wall provider in order to
                prevent fraud and properly credit your account.  <br className='my-2' />
                Other Third Parties
                ...
                marketing purposes, as permitted by law. <br className='my-2' />
                Sale or Bankruptcy
                ...
                to honor commitments we made in this Privacy Policy. <br className='my-2' />
            ...
            <p>
                TRACKING TECHNOLOGIES <br className='my-2' />
                Cookies and Web Beacons <br className='my-2' />
                ...
                Internet-Based Advertising <br className='my-2' />
                ...
                Website Analytics <br className='my-2' />
                We may also partner with selected third-party vendors, such as Google Analytics to allow
                tracking technologies and remarketing services on the Application through the use of first-party
                cookies and third-party cookies, to, among other things, analyze and track users’ use of the
                Application, determine the popularity of certain content, and better understand online activity. By
                accessing the Application, you consent to the collection and use of your information by these
            ...
            <p>THIRD-PARTY WEBSITES <br className='my-2' />
                ...
                or from the Application.</p>

            <p>SECURITY OF YOUR INFORMATION <br className='my-2' />
            ...
            <p>POLICY FOR CHILDREN <br className='my-2' />
            ...
            <p>
                CONTROLS FOR DO-NOT-TRACK FEATURES <br className='my-2' />
            ...
            <p>OPTIONS REGARDING YOUR INFORMATION <br className='my-2' />
                Account Information <br className='my-2' />
                ...
                <ul>
                    ...
                    <li> Contacting us using the contact information provided below
                        ...
                        Use, and/or comply with legal requirements. <br className='my-2' />
                    ...
                    <li> Login into your account settings and update your preferences.</li>
                    <li>Contacting us using the contact information provided below  If you no longer wish to receive correspondence, emails, or other communications from third
                        parties, you are responsible for contacting the third party directly.</li>
                    <p>CAMEROON PRIVACY RIGHTS
                        In the preamble to the Constitution of the Republic of Cameroon, Law No. 96/6 of 18 January
                        1996 revising the Constitution of 02 June 1972, as amended and supplemented by Law No.
                        2008/001 of 14 April 2008 (‘the Constitution’), it is stated that:</p>
                    <li> the people of Cameroon affirm their attachment to the fundamental freedoms enshrined
                        in the Universal Declaration of Human Rights 1945, the Charter of the United Nations
                        1945, the African Charter on Human and Peoples’ Rights 1981, which are all duly ratified;</li>
                    <li> international conventions relating thereto;</li>
                    <li> freedom and security are guaranteed to every individual with due respect for the rights of
                        others and the best interests of the State;</li>
                    <li> privacy of all correspondence is inviolable – no interference may be allowed except as
                        provided in a judicial decision.</li>
                    <p>Data protection is, therefore, a right enshrined in the Constitution. <br className='my-2' />
                        If you are under 18 years of age, reside in Cameroon, and have a registered account with Bohikor
                        SAS, you have the right to request the removal of unwanted data that you publicly post on the
                        Application. To request the removal of such data, please contact us using the contact
                        information provided below, and include the email address associated with your account and a
                        statement that you reside in Cameroon. We will make sure the data is not publicly displayed on
                        the Application, but please be aware that the data may not be completely or comprehensively
